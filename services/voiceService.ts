...
/**
 * Generates and plays an AI voice briefing for a specific alert.
 */
export async function speakAlert(text: string): Promise<void> {
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: [{ parts: [{ text: `Attention: ${text}. Repeat, ${text}. Please follow safety protocols immediately.` }] }],
      config: {
